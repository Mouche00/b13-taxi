                ...
                <div class="border-black border-4 border-dashed rounded-xl font-black text-xl">
                    ...
                    @foreach ($routes as $route)
                        <form action="/route/add" method="POST" class="p-4 pt-12 relative">
                            ...
                            <div class="flex items-center gap-2">
                                <div class="flex flex-col items-center p-2">
                                    <img width="100px" src="{{ asset('/images/ship.png') }}" alt="">
                                    <input type="text" name="departure" id="departure" value="{{ $route->departure }}" class="text-xs text-center" disabled>
                                </div>
                                <div class="w-64 flex items-center">
                                    <div class="relative">
                                        <span class="inline-block w-2 h-2 rounded-full bg-black"></span>
                                ...
                                <div class="flex flex-col items-center m-2">
                                    <img width="100px" src="{{ asset('/images/ship.png') }}" alt="">
                                    <input type="text" name="destination" id="destination" value="{{ $route->destination }}" class="text-xs text-center" disabled>
                                </div>
                            </div>
